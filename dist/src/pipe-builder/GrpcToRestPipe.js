...
exports.GrpcToRestPipe = void 0;
const ErrorMessage_1 = require("@/utils/ErrorMessage");
const constants_1 = require("@grpc/grpc-js/build/src/constants");
const PipeHandler_1 = require("@/pipe-builder/PipeHandler");
class GrpcToRestPipe extends PipeHandler_1.PipeHandler {
    ...
    setHandler(sourceOptions, destOptions) {
        ...
        sourceReader
            .on("data", (data) => destWriter.write(data.chunkData))
...
exports.GrpcToRestPipe = GrpcToRestPipe;
